"""
Altered from: https://github.com/teamclairvoyant/airflow-maintenance-dags/blob/master/log-cleanup/airflow-log-cleanup.py
...
DEFAULT_MAX_LOG_AGE_IN_DAYS = Variable.get(
    "log_cleanup_dag__max_log_age_in_days", 7
)
...
ENABLE_DELETE_CHILD_LOG = Variable.get(
    "log_cleanup_dag__enable_delete_child_log", "False"
)
